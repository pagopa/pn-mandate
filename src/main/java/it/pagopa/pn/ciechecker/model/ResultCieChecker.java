...
public enum ResultCieChecker {
    ...
    KO_EXC_INVALID_PARAMETER_CODFISCDELEGANTE(CieCheckerConstants.EXC_INVALID_PARAMETER_CODFISCDELEGANTE),
    KO_EXC_INVALID_PARAMETER_CIECAANDKEY(CieCheckerConstants.EXC_INVALID_PARAMETER_CIECAANDKEY),
    ...
    KO_EXC_NOVALID_URI_CSCA_ANCHORS ( CieCheckerConstants.EXC_NOVALID_URI_CSCA_ANCHORS),
    KO_EXC_NOVALID_CSCA_ANCHORS ( CieCheckerConstants.EXC_NOVALID_CSCA_ANCHORS),
    ...
    KO_EXC_NOFOUND_EXPIRE_DATE_DG1(CieCheckerConstants.EXC_NOFOUND_EXPIRE_DATE_DG1),

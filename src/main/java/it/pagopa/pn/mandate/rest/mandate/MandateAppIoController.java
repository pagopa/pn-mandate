...
public class MandateAppIoController implements AppIoPnMandateCreateApi {
    ...
    @Override
    public Mono<ResponseEntity<MandateCreationResponse>> createIOMandate(String xPagopaPnUid, String xPagopaPnCxId, CxTypeAuthFleet xPagopaPnCxType, String xPagopaCxTaxid, List<String> xPagopaPnCxGroups, Mono<MandateCreationRequest> mandateCreationRequest,  final ServerWebExchange exchange) {
